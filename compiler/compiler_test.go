...
import (
	...
	"github.com/tamurayoshiya/monkey/object"
	"github.com/tamurayoshiya/monkey/parser"
)
...
// expectedInstructionsが
// slice of (slices of bytes = code.Instructions)
// なのでflattenする
...
func testConstants(t *testing.T, expected []interface{}, actual []object.Object) error {
	if len(expected) != len(actual) {
		return fmt.Errorf("worng number of constants. got=%d, wnat=%d", len(actual), len(expected))
	}
...
func TestCompilerScopes(t *testing.T) {
	...
	if compiler.scopeIndex != 0 {
		t.Errorf("scopeIndex wrong. got=%d, wnat=%d", compiler.scopeIndex, 0)
	}
	...
	// the insturctions emitted in one scope
	// should have no effect on the instructions
	// in another scope
